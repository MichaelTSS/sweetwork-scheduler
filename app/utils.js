 ...
 */
module.exports.computeDensity = function (numResults = 0, timestampFrom, timestampTo) {
    ...
    const numHours = moment.duration(moment.unix(timestampTo - timestampFrom).valueOf()).asHours();
