...
describe('FeedsManager', function () {
  ...
  describe('Delete one topic', function () {
    ...
    it('should find an empty list of feed keys in global feedsList', function (done) {
    ...
    it('should find no list of feed keys in the list by secondTopicId', function (done) {
      cli.zcount({ key: RedisKeys.feedsListByTopicId(secondTopicId) }).then(count => {
        expect(count).to.equal(0);
        done();
      });
    });
